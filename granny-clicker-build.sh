...
zip -r granny-clicker-v1.1.0-win32.zip .
mv granny-clicker-v1.1.0-win32.zip "/storage/emulated/0/Granny Clicker/dist"

cd ../win64
zip -r granny-clicker-v1.1.0-win64.zip .
mv granny-clicker-v1.1.0-win64.zip "/storage/emulated/0/Granny Clicker/dist"

cd ../win-arm64
zip -r granny-clicker-v1.1.0-win-arm64.zip .
mv granny-clicker-v1.1.0-win-arm64.zip "/storage/emulated/0/Granny Clicker/dist"

# "macOS Packages..."

cd ../osx64
zip -r -y granny-clicker-v1.1.0-osx64.zip .
mv granny-clicker-v1.1.0-osx64.zip "/storage/emulated/0/Granny Clicker/dist"

cd ../osx-arm64
zip -r -y granny-clicker-v1.1.0-osx-arm64.zip .
mv granny-clicker-v1.1.0-osx-arm64.zip "/storage/emulated/0/Granny Clicker/dist"

# "Linux Packages..."

cd ../linux64
tar -czvf granny-clicker-v1.1.0-linux64.tar.gz .
mv granny-clicker-v1.1.0-linux64.tar.gz "/storage/emulated/0/Granny Clicker/dist"

cd ../linux-arm64
tar -czvf granny-clicker-v1.1.0-linux-arm64.tar.gz .
mv granny-clicker-v1.1.0-linux-arm64.tar.gz "/storage/emulated/0/Granny Clicker/dist"
